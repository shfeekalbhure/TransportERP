...
public partial class GeoHierarchy : Migration
{
    ...
    {
        migrationBuilder.CreateTable(name: "countries", columns: table => new
        {
        ...
        }, constraints: table => table.PrimaryKey("PK_countries", x => x.id), comment: "utf8mb4");
