...
namespace TransportERP.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260828224241_GreenfieldTenantMembershipIsolation")]
    partial class GreenfieldTenantMembershipIsolation
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TransportERP.Infrastructure.Persistence.UserMembership", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    NpgsqlIndexBuilderExtensions.AreNullsDistinct(b.HasIndex("UserId", "CompanyId", "BranchId"), false);

                    b.HasIndex("UserId", "Status", "CompanyId");

                    b.ToTable("user_memberships", "transport_erp", t =>
                        {
            ...
            modelBuilder.Entity("TransportERP.Infrastructure.Persistence.UserPermissionGrant", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("MembershipId", "UserId", "CompanyId");

                    b.ToTable("user_permission_grants", "transport_erp", t =>
                        {
            ...
            modelBuilder.Entity("TransportERP.Infrastructure.Persistence.UserRoleGrant", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("user_role_grants", "transport_erp", t =>
                        {
            ...
            modelBuilder.Entity("TransportERP.Infrastructure.Persistence.UserPermissionGrant", b =>
                {
                    ...
                    b.HasOne("TransportERP.Infrastructure.Persistence.UserMembership", null)
                        .WithMany()
                        .HasForeignKey("MembershipId", "UserId", "CompanyId")
                        .HasPrincipalKey("Id", "UserId", "CompanyId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
                });
