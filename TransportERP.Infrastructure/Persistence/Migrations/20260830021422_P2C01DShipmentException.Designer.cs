...
namespace TransportERP.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260830021422_P2C01DShipmentException")]
    partial class P2C01DShipmentException
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TransportERP.Infrastructure.Persistence.ArrivalReceiptEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("TripId", "LocationId");

                    b.HasIndex("CompanyId", "ReceivingBranchId", "CreateClientOperationId")
                        .IsUnique();

                    b.HasIndex("TripId", "ManifestId", "LocationId")
                        .IsUnique();

                    b.ToTable("arrival_receipts", "transport_erp", t =>
                        {
                            t.HasCheckConstraint("ck_arrival_receipt_status", "\"Status\" IN ('DRAFT','FINALIZED')");
                        });
                });

            modelBuilder.Entity("TransportERP.Infrastructure.Persistence.ArrivalReceiptLineEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid>("ArrivalReceiptId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("ManifestLineId");

                    b.HasIndex("ArrivalReceiptId", "ManifestLineId")
                        .IsUnique();

                    b.HasIndex("WaybillItemId", "DifferenceType");

                    b.ToTable("arrival_receipt_lines", "transport_erp", t =>
                        {
            ...
            modelBuilder.Entity("TransportERP.Infrastructure.Persistence.WarehouseHoldingEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("SourceClientOperationId")
                        .IsRequired()
                        .HasMaxLength(160)
                        .HasColumnType("character varying(160)");
                    ...
                    b.HasIndex("CompanyId", "BranchId", "WaybillItemId", "LocationId", "Status");

                    b.ToTable("warehouse_holdings", "transport_erp", t =>
                        {
            ...
            modelBuilder.Entity("TransportERP.Infrastructure.Persistence.ArrivalReceiptLineEntity", b =>
                {
                    b.HasOne("TransportERP.Infrastructure.Persistence.ArrivalReceiptEntity", "ArrivalReceipt")
                        .WithMany("Lines")
                        .HasForeignKey("ArrivalReceiptId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("TransportERP.Infrastructure.Persistence.ManifestLineEntity", "ManifestLine")
                        .WithMany()
                    ...
                    b.Navigation("ArrivalReceipt");

                    b.Navigation("ManifestLine");
