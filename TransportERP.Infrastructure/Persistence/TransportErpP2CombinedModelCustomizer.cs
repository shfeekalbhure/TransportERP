...
/// <summary>
/// Composes the closed P2-C01-A foundation, P2-C01-B finance model, the additive
/// P2-C01-C release/trip/manifest execution model, and authorized Greenfield DBP units.
/// </summary>
