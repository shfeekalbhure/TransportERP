...
public sealed record CountryDto(Guid Id, string Code, string ArabicName, string? EnglishName, string? NationalityName, bool IsActive, int Version,
    string? ISO2 = null, string? ISO3 = null, string? DialingCode = null) : GeoDto(Id, Code, ArabicName, EnglishName, IsActive, Version);
...
public sealed record CreateCountryRequest(string Code, string ArabicName, string? EnglishName, string? NationalityName,
    string? ISO2 = null, string? ISO3 = null, string? DialingCode = null);
public sealed record UpdateCountryRequest(string Code, string ArabicName, string? EnglishName, string? NationalityName, int ExpectedVersion,
    string? ISO2 = null, string? ISO3 = null, string? DialingCode = null);
public sealed record GEN003PrintRequest(string? SearchText = null, string? Sort = null, string? Direction = null, bool? IsActive = null);
