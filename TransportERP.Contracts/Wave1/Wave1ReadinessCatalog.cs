...
public static class Wave1ReadinessCatalog
{
    private static readonly IReadOnlyDictionary<string, Wave1ReadinessEntry> Entries =
        new Dictionary<string, Wave1ReadinessEntry>(StringComparer.OrdinalIgnoreCase)
        {
            ...
            ["GEN-014"] = Hold("GEN-014", "CONTRACT_CODE_PARITY", "Current W1 and SRC-057 define Language as Id/Code/CultureCode/Direction/IsActive/Version and W2 exposes only List/Get/Create/Update/Disable. The branch still persists ArabicName/EnglishName/IsRtl and translations, so contract/code/migration parity is not closed."),
            ...
            ["ACC-050"] = Hold("ACC-050", "OTS_W1_005_CASH_FLOW_CLASSIFICATION", "OTS-W1-005 Cash Flow classification remains gate-bound before ACC-050. Existing heuristic source-type classification is not governing and cannot earn READY."),
