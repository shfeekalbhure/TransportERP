...
partial class UcCities
{
    ...
    private void InitializeComponent()
    {
        ...
        txtCityCode = new RequiredTextBox();
        ...
        // القالب الواحد يحتوي الأوامر والتنبيه والبحث والجدول والتصفح ومعلومات التدقيق.
        screenShell.Dock = DockStyle.Fill;
        screenShell.Name = "screenShell";
        screenShell.RightToLeft = RightToLeft.Yes;

        // تنظيم حقول المدينة فقط داخل عمودين ثابتين.
        ...
        ConfigureRequiredTextBox(txtCityCode);
        ...
        AddField(tblData, "كود المدينة *", txtCityCode, 2, 1);
        AddField(tblData, "الاسم العربي *", txtNameAr, 0, 2);
        AddField(tblData, "الاسم الإنجليزي", txtNameEn, 2, 2);
        ...
        // أعمدة جدول المدن فقط.
        screenShell.Grid.AutoGenerateColumns = false;
        screenShell.Grid.Columns.Add("colCityCode", "كود المدينة");
        screenShell.Grid.Columns.Add("colNameAr", "اسم المدينة");
    ...
    /// <summary>إضافة عنوان وحقل إلى الصف المحدد بنفس المسافات الموحدة.</summary>
    ...
    /// <summary>إنشاء Label عربي ثابت ومحاذاة يمين.</summary>
    ...
    /// <summary>تهيئة حقل إلزامي موحد من Toolbox.</summary>
