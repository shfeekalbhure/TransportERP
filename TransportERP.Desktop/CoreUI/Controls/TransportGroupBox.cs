...
/// <summary>
/// حاوية موحدة لأقسام الشاشة مع لون حدود ثابت وخفيف.
/// نستخدمها بدل GroupBox العادي حتى تكون جميع الحواف بنفس اللون في كل الشاشات.
/// </summary>
[ToolboxItem(true)]
public sealed class TransportGroupBox : GroupBox
{
    ...
    protected override void OnPaint(PaintEventArgs e)
    {
        ...
        // الحد العلوي مع ترك فتحة حول عنوان الحاوية.
