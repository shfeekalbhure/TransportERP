...
public partial class FrmDashboard : Form
{
    ...
    private void ConfigureSecurityAndAccountingMenus()
    {
        ...
        _accountingMenu = CreateScreenMenu(new[]
        {
            ...
            ("ACC-021", "دفتر اليومية"), ("ACC-022", "دفتر الأستاذ العام"),
            ("ACC-023", "كشف حساب"), ("ACC-024", "ميزان المراجعة"),
            ("ACC-025", "قائمة الدخل"), ("ACC-026", "الميزانية العمومية"),
            ("ACC-027", "قائمة التدفقات النقدية"), ("ACC-028", "دفتر الأستاذ المساعد"),
