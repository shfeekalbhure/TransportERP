...
partial class FrmCurrencies
{
    ...
    private System.Windows.Forms.TextBox txtMinorUnitName;
    private System.Windows.Forms.TextBox txtMinorUnitSymbol;
    ...
    private void InitializeComponent()
    {
        ...
        txtCurrencyCode = new System.Windows.Forms.TextBox();
            txtCurrencyCode.Name = "txtCurrencyCode"; txtCurrencyCode.Dock = System.Windows.Forms.DockStyle.Fill; txtCurrencyCode.RightToLeft = System.Windows.Forms.RightToLeft.Yes; txtCurrencyCode.Margin = new System.Windows.Forms.Padding(8, 4, 12, 4);
            ...
            txtIsoCode = new System.Windows.Forms.TextBox();
            txtIsoCode.Name = "txtIsoCode"; txtIsoCode.Dock = System.Windows.Forms.DockStyle.Fill; txtIsoCode.RightToLeft = System.Windows.Forms.RightToLeft.Yes; txtIsoCode.Margin = new System.Windows.Forms.Padding(8, 4, 12, 4);
            txtSymbol = new System.Windows.Forms.TextBox();
            txtSymbol.Name = "txtSymbol"; txtSymbol.Dock = System.Windows.Forms.DockStyle.Fill; txtSymbol.RightToLeft = System.Windows.Forms.RightToLeft.Yes; txtSymbol.Margin = new System.Windows.Forms.Padding(8, 4, 12, 4);
            nudDecimalPlaces = new System.Windows.Forms.NumericUpDown();
            nudDecimalPlaces.Name = "nudDecimalPlaces"; nudDecimalPlaces.Dock = System.Windows.Forms.DockStyle.Fill; nudDecimalPlaces.RightToLeft = System.Windows.Forms.RightToLeft.Yes; nudDecimalPlaces.Margin = new System.Windows.Forms.Padding(8, 4, 12, 4);
            nudDecimalPlaces.DecimalPlaces = 2; nudDecimalPlaces.Maximum = 100000000;
            txtMinorUnitName = new System.Windows.Forms.TextBox();
            txtMinorUnitName.Name = "txtMinorUnitName"; txtMinorUnitName.Dock = System.Windows.Forms.DockStyle.Fill; txtMinorUnitName.RightToLeft = System.Windows.Forms.RightToLeft.Yes; txtMinorUnitName.Margin = new System.Windows.Forms.Padding(8, 4, 12, 4);
            txtMinorUnitSymbol = new System.Windows.Forms.TextBox();
            txtMinorUnitSymbol.Name = "txtMinorUnitSymbol"; txtMinorUnitSymbol.Dock = System.Windows.Forms.DockStyle.Fill; txtMinorUnitSymbol.RightToLeft = System.Windows.Forms.RightToLeft.Yes; txtMinorUnitSymbol.Margin = new System.Windows.Forms.Padding(8, 4, 12, 4);
        ...
        lblScreenCode.Name="lblScreenCode"; lblScreenCode.Text="GEN-009"; lblScreenCode.AutoSize=true; lblScreenCode.Font=new System.Drawing.Font("Segoe UI",11F,System.Drawing.FontStyle.Bold); lblScreenCode.ForeColor=System.Drawing.Color.FromArgb(46,116,181); lblScreenCode.Location=new System.Drawing.Point(0,8);
        lblScreenTitle.Name="lblScreenTitle"; lblScreenTitle.Text="العملات"; lblScreenTitle.AutoSize=true; lblScreenTitle.Font=new System.Drawing.Font("Segoe UI",20F,System.Drawing.FontStyle.Bold); lblScreenTitle.ForeColor=System.Drawing.Color.FromArgb(31,41,55); lblScreenTitle.Location=new System.Drawing.Point(0,27);
        lblBreadcrumb.Name="lblBreadcrumb"; lblBreadcrumb.Text="التهيئة العامة / العملات"; lblBreadcrumb.AutoSize=true; lblBreadcrumb.Font=new System.Drawing.Font("Segoe UI",11F); lblBreadcrumb.ForeColor=System.Drawing.Color.Gray; lblBreadcrumb.Location=new System.Drawing.Point(0,49);
        ...
        tlpMainData.Name="tlpMainData"; tlpMainData.Dock=System.Windows.Forms.DockStyle.Top; tlpMainData.RightToLeft=System.Windows.Forms.RightToLeft.Yes; tlpMainData.ColumnCount=4; tlpMainData.RowCount=6; tlpMainData.Padding=new System.Windows.Forms.Padding(16); tlpMainData.BackColor=System.Drawing.Color.White; tlpMainData.AutoScroll=true;
        ...
        AddField(tlpMainData, "كود العملة", txtCurrencyCode, 0);
            AddField(tlpMainData, "الاسم العربي", txtNameAr, 1);
            AddField(tlpMainData, "الاسم الإنجليزي", txtNameEn, 2);
            AddField(tlpMainData, "رمز ISO", txtIsoCode, 3);
            AddField(tlpMainData, "الرمز المختصر", txtSymbol, 4);
            AddField(tlpMainData, "عدد المنازل العشرية", nudDecimalPlaces, 5);
            AddField(tlpMainData, "اسم الجزء", txtMinorUnitName, 6);
            AddField(tlpMainData, "رمز الجزء", txtMinorUnitSymbol, 7);
            AddField(tlpMainData, "ترتيب العرض", nudDisplayOrder, 8);
            AddField(tlpMainData, "الحالة", cmbStatus, 9);
        ...
        dgvRecords.Columns.Add(new System.Windows.Forms.DataGridViewTextBoxColumn { Name = "col3", HeaderText = "ISO", ReadOnly = true });
        dgvRecords.Columns.Add(new System.Windows.Forms.DataGridViewTextBoxColumn { Name = "col4", HeaderText = "الرمز", ReadOnly = true });
        dgvRecords.Columns.Add(new System.Windows.Forms.DataGridViewTextBoxColumn { Name = "col5", HeaderText = "المنازل", ReadOnly = true });
        ...
        AutoScaleMode=System.Windows.Forms.AutoScaleMode.Font; BackColor=System.Drawing.Color.FromArgb(249,250,251); ClientSize=new System.Drawing.Size(1280,900); Controls.Add(tlpRoot); Font=new System.Drawing.Font("Segoe UI",10F); MinimumSize=new System.Drawing.Size(1180,780); Name="FrmCurrencies"; RightToLeft=System.Windows.Forms.RightToLeft.Yes; RightToLeftLayout=true; StartPosition=System.Windows.Forms.FormStartPosition.CenterScreen; Text="GEN-009 — العملات";
        ResumeLayout(false);
    }
