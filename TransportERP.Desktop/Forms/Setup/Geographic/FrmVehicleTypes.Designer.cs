...
partial class FrmVehicleTypes
{
    ...
    private System.Windows.Forms.Label lblVehicleTypeCode = null!, lblNameAr = null!, lblNameEn = null!, lblCategory = null!, lblSeats = null!, lblPayload = null!, lblLength = null!, lblWidth = null!, lblHeight = null!, lblAxles = null!, lblBodyType = null!, lblRoofType = null!, lblOwnership = null!, lblStatus = null!, lblNotes = null!;
    ...
    private void InitializeComponent()
    {
        ...
        lblVehicleTypeCode = new System.Windows.Forms.Label(); lblNameAr = new System.Windows.Forms.Label(); lblNameEn = new System.Windows.Forms.Label(); lblCategory = new System.Windows.Forms.Label(); lblSeats = new System.Windows.Forms.Label(); lblPayload = new System.Windows.Forms.Label(); lblLength = new System.Windows.Forms.Label(); lblWidth = new System.Windows.Forms.Label(); lblHeight = new System.Windows.Forms.Label(); lblAxles = new System.Windows.Forms.Label(); lblBodyType = new System.Windows.Forms.Label(); lblRoofType = new System.Windows.Forms.Label(); lblOwnership = new System.Windows.Forms.Label(); lblStatus = new System.Windows.Forms.Label(); lblNotes = new System.Windows.Forms.Label();
        ...
        tlpRoot.RowStyles.Add(new System.Windows.Forms.RowStyle(System.Windows.Forms.SizeType.Absolute, 400F));
        ...
        pnlC002Header.Name = "pnlC002Header"; pnlC002Header.Dock = System.Windows.Forms.DockStyle.Top; pnlC002Header.Height = 88; pnlC002Header.AutoScroll = false; pnlC002Header.AutoSize = false; pnlC002Header.Padding = new System.Windows.Forms.Padding(16, 10, 16, 10); pnlC002Header.BackColor = System.Drawing.Color.White; pnlC002Header.RightToLeft = System.Windows.Forms.RightToLeft.Yes;
        ...
        btnNew.Margin=btnSave.Margin=btnEdit.Margin=btnStop.Margin=btnDelete.Margin=btnPrint.Margin=btnExport.Margin=btnCancel.Margin=btnMore.Margin=new System.Windows.Forms.Padding(4,0,4,0); btnNew.RightToLeft=btnSave.RightToLeft=btnEdit.RightToLeft=btnStop.RightToLeft=btnDelete.RightToLeft=btnPrint.RightToLeft=btnExport.RightToLeft=btnCancel.RightToLeft=btnMore.RightToLeft=System.Windows.Forms.RightToLeft.Yes; btnSave.BackColor=System.Drawing.Color.FromArgb(46,116,181); btnSave.ForeColor=System.Drawing.Color.White; btnDelete.BackColor=System.Drawing.Color.FromArgb(198,40,40); btnDelete.ForeColor=System.Drawing.Color.White;
        ...
        for (int i = 0; i < 7; i++) tlpC005Data.RowStyles.Add(new System.Windows.Forms.RowStyle(System.Windows.Forms.SizeType.Absolute, 44F)); tlpC005Data.RowStyles.Add(new System.Windows.Forms.RowStyle(System.Windows.Forms.SizeType.Percent, 100F));
        lblVehicleTypeCode = new System.Windows.Forms.Label { Name="lblVehicleTypeCode", Text="كود النوع *", Dock=System.Windows.Forms.DockStyle.Fill, TextAlign=System.Drawing.ContentAlignment.MiddleRight, Font=new System.Drawing.Font("Arial",11F,System.Drawing.FontStyle.Bold) };
        lblNameAr = new System.Windows.Forms.Label { Name="lblNameAr", Text="الاسم العربي *", Dock=System.Windows.Forms.DockStyle.Fill, TextAlign=System.Drawing.ContentAlignment.MiddleRight, Font=new System.Drawing.Font("Arial",11F,System.Drawing.FontStyle.Bold) };
        lblNameEn = new System.Windows.Forms.Label { Name="lblNameEn", Text="الاسم الإنجليزي *", Dock=System.Windows.Forms.DockStyle.Fill, TextAlign=System.Drawing.ContentAlignment.MiddleRight, Font=new System.Drawing.Font("Arial",11F,System.Drawing.FontStyle.Bold) };
        lblCategory = new System.Windows.Forms.Label { Name="lblCategory", Text="الفئة *", Dock=System.Windows.Forms.DockStyle.Fill, TextAlign=System.Drawing.ContentAlignment.MiddleRight, Font=new System.Drawing.Font("Arial",11F,System.Drawing.FontStyle.Bold) };
        lblSeats = new System.Windows.Forms.Label { Name="lblSeats", Text="عدد المقاعد", Dock=System.Windows.Forms.DockStyle.Fill, TextAlign=System.Drawing.ContentAlignment.MiddleRight };
        lblPayload = new System.Windows.Forms.Label { Name="lblPayload", Text="الحمولة بالطن", Dock=System.Windows.Forms.DockStyle.Fill, TextAlign=System.Drawing.ContentAlignment.MiddleRight };
        lblLength = new System.Windows.Forms.Label { Name="lblLength", Text="الطول", Dock=System.Windows.Forms.DockStyle.Fill, TextAlign=System.Drawing.ContentAlignment.MiddleRight };
        lblWidth = new System.Windows.Forms.Label { Name="lblWidth", Text="العرض", Dock=System.Windows.Forms.DockStyle.Fill, TextAlign=System.Drawing.ContentAlignment.MiddleRight };
        lblHeight = new System.Windows.Forms.Label { Name="lblHeight", Text="الارتفاع", Dock=System.Windows.Forms.DockStyle.Fill, TextAlign=System.Drawing.ContentAlignment.MiddleRight };
        lblAxles = new System.Windows.Forms.Label { Name="lblAxles", Text="عدد المحاور", Dock=System.Windows.Forms.DockStyle.Fill, TextAlign=System.Drawing.ContentAlignment.MiddleRight };
        lblBodyType = new System.Windows.Forms.Label { Name="lblBodyType", Text="نوع الهيكل", Dock=System.Windows.Forms.DockStyle.Fill, TextAlign=System.Drawing.ContentAlignment.MiddleRight };
        lblRoofType = new System.Windows.Forms.Label { Name="lblRoofType", Text="نوع السطح", Dock=System.Windows.Forms.DockStyle.Fill, TextAlign=System.Drawing.ContentAlignment.MiddleRight };
        lblOwnership = new System.Windows.Forms.Label { Name="lblOwnership", Text="نوع الملكية", Dock=System.Windows.Forms.DockStyle.Fill, TextAlign=System.Drawing.ContentAlignment.MiddleRight };
        lblStatus = new System.Windows.Forms.Label { Name="lblStatus", Text="الحالة *", Dock=System.Windows.Forms.DockStyle.Fill, TextAlign=System.Drawing.ContentAlignment.MiddleRight, Font=new System.Drawing.Font("Arial",11F,System.Drawing.FontStyle.Bold) };
        lblNotes = new System.Windows.Forms.Label { Name="lblNotes", Text="الملاحظات", Dock=System.Windows.Forms.DockStyle.Fill, TextAlign=System.Drawing.ContentAlignment.MiddleRight };
        ...
        txtVehicleTypeCode.Margin=txtNameAr.Margin=txtNameEn.Margin=cmbCategory.Margin=nudSeats.Margin=nudPayloadTons.Margin=nudLength.Margin=nudWidth.Margin=nudHeight.Margin=nudAxles.Margin=cmbBodyType.Margin=cmbRoofType.Margin=cmbOwnershipType.Margin=cmbStatus.Margin=rtbNotes.Margin=new System.Windows.Forms.Padding(8,4,12,4); txtVehicleTypeCode.MinimumSize=txtNameAr.MinimumSize=txtNameEn.MinimumSize=cmbCategory.MinimumSize=nudSeats.MinimumSize=nudPayloadTons.MinimumSize=nudLength.MinimumSize=nudWidth.MinimumSize=nudHeight.MinimumSize=nudAxles.MinimumSize=cmbBodyType.MinimumSize=cmbRoofType.MinimumSize=cmbOwnershipType.MinimumSize=cmbStatus.MinimumSize=new System.Drawing.Size(0,36);
        ...
        cmbFilterStatus.Name="cmbFilterStatus"; cmbFilterStatus.Dock=System.Windows.Forms.DockStyle.Fill; cmbFilterStatus.RightToLeft=System.Windows.Forms.RightToLeft.Yes; cmbFilterStatus.DropDownStyle=System.Windows.Forms.ComboBoxStyle.DropDownList;
        cmbFilterCategory.Name="cmbFilterCategory"; cmbFilterCategory.Dock=System.Windows.Forms.DockStyle.Fill; cmbFilterCategory.RightToLeft=System.Windows.Forms.RightToLeft.Yes; cmbFilterCategory.DropDownStyle=System.Windows.Forms.ComboBoxStyle.DropDownList;
        btnSearch.Name="btnSearch"; btnSearch.Text="بحث"; btnSearch.RightToLeft=System.Windows.Forms.RightToLeft.Yes; btnSearch.Dock=System.Windows.Forms.DockStyle.Fill; btnSearch.FlatStyle=System.Windows.Forms.FlatStyle.Flat; btnSearch.BackColor=System.Drawing.Color.FromArgb(46,116,181); btnSearch.ForeColor=System.Drawing.Color.White;
        btnClearFilters.Name="btnClearFilters"; btnClearFilters.Text="مسح"; btnClearFilters.RightToLeft=System.Windows.Forms.RightToLeft.Yes; btnClearFilters.Dock=System.Windows.Forms.DockStyle.Fill; btnClearFilters.FlatStyle=System.Windows.Forms.FlatStyle.Flat;
        ...
        colCode.Name="colCode"; colCode.HeaderText="كود النوع"; colCode.ReadOnly=true; colCode.SortMode=System.Windows.Forms.DataGridViewColumnSortMode.Automatic; colNameAr.Name="colNameAr"; colNameAr.HeaderText="الاسم العربي"; colNameAr.ReadOnly=true; colNameAr.SortMode=System.Windows.Forms.DataGridViewColumnSortMode.Automatic; colCategory.Name="colCategory"; colCategory.HeaderText="الفئة"; colCategory.ReadOnly=true; colCategory.SortMode=System.Windows.Forms.DataGridViewColumnSortMode.Automatic; colSeats.Name="colSeats"; colSeats.HeaderText="المقاعد"; colSeats.ReadOnly=true; colSeats.SortMode=System.Windows.Forms.DataGridViewColumnSortMode.Automatic; colPayload.Name="colPayload"; colPayload.HeaderText="الحمولة"; colPayload.ReadOnly=true; colPayload.SortMode=System.Windows.Forms.DataGridViewColumnSortMode.Automatic; colStatus.Name="colStatus"; colStatus.HeaderText="الحالة"; colStatus.ReadOnly=true; colStatus.SortMode=System.Windows.Forms.DataGridViewColumnSortMode.Automatic;
        ...
        btnFirst.Size=btnPrevious.Size=btnNext.Size=btnLast.Size=new System.Drawing.Size(68,36); btnFirst.RightToLeft=btnPrevious.RightToLeft=btnNext.RightToLeft=btnLast.RightToLeft=System.Windows.Forms.RightToLeft.Yes; btnFirst.FlatStyle=btnPrevious.FlatStyle=btnNext.FlatStyle=btnLast.FlatStyle=System.Windows.Forms.FlatStyle.Flat;
        lblPageNumber.Name="lblPageNumber"; lblPageNumber.Text="1"; lblPageNumber.Size=new System.Drawing.Size(52,36); lblPageNumber.TextAlign=System.Drawing.ContentAlignment.MiddleCenter; cmbPageSize.Name="cmbPageSize"; cmbPageSize.Size=new System.Drawing.Size(90,36); cmbPageSize.RightToLeft=System.Windows.Forms.RightToLeft.Yes; cmbPageSize.DropDownStyle=System.Windows.Forms.ComboBoxStyle.DropDownList; lblTotalRecords.Name="lblTotalRecords"; lblTotalRecords.Text="إجمالي السجلات: 0"; lblTotalRecords.AutoSize=true; lblTotalRecords.Padding=new System.Windows.Forms.Padding(12,8,0,0);
