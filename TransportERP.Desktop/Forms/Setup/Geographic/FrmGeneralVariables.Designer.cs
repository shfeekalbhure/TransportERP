...
partial class FrmGeneralVariables
{
    ...
    private System.Windows.Forms.TextBox txtVariableKey;
    private System.Windows.Forms.TextBox txtNameAr;
    private System.Windows.Forms.RichTextBox rtbDescription;
    private System.Windows.Forms.ComboBox cmbGroup;
    private System.Windows.Forms.ComboBox cmbDataType;
    private System.Windows.Forms.TextBox txtDefaultValue;
    private System.Windows.Forms.ComboBox cmbApplicationLevel;
    private System.Windows.Forms.CheckBox chkAllowOverride;
    private System.Windows.Forms.TextBox txtCurrentValue;
    private System.Windows.Forms.ComboBox cmbSensitivity;
    private System.Windows.Forms.CheckBox chkRequiresRestart;
    ...
    private void InitializeComponent()
    {
        ...
        txtVariableKey = new System.Windows.Forms.TextBox();
            txtVariableKey.Name = "txtVariableKey"; txtVariableKey.Dock = System.Windows.Forms.DockStyle.Fill; txtVariableKey.RightToLeft = System.Windows.Forms.RightToLeft.Yes; txtVariableKey.Margin = new System.Windows.Forms.Padding(8, 4, 12, 4);
            ...
            rtbDescription.Name = "rtbDescription"; rtbDescription.Dock = System.Windows.Forms.DockStyle.Fill; rtbDescription.RightToLeft = System.Windows.Forms.RightToLeft.Yes; rtbDescription.Margin = new System.Windows.Forms.Padding(8, 4, 12, 4);
            rtbDescription.Height = 54;
            cmbGroup = new System.Windows.Forms.ComboBox();
            cmbGroup.Name = "cmbGroup"; cmbGroup.Dock = System.Windows.Forms.DockStyle.Fill; cmbGroup.RightToLeft = System.Windows.Forms.RightToLeft.Yes; cmbGroup.Margin = new System.Windows.Forms.Padding(8, 4, 12, 4);
            cmbDataType = new System.Windows.Forms.ComboBox();
            cmbDataType.Name = "cmbDataType"; cmbDataType.Dock = System.Windows.Forms.DockStyle.Fill; cmbDataType.RightToLeft = System.Windows.Forms.RightToLeft.Yes; cmbDataType.Margin = new System.Windows.Forms.Padding(8, 4, 12, 4);
            txtDefaultValue = new System.Windows.Forms.TextBox();
            txtDefaultValue.Name = "txtDefaultValue"; txtDefaultValue.Dock = System.Windows.Forms.DockStyle.Fill; txtDefaultValue.RightToLeft = System.Windows.Forms.RightToLeft.Yes; txtDefaultValue.Margin = new System.Windows.Forms.Padding(8, 4, 12, 4);
            cmbApplicationLevel = new System.Windows.Forms.ComboBox();
            cmbApplicationLevel.Name = "cmbApplicationLevel"; cmbApplicationLevel.Dock = System.Windows.Forms.DockStyle.Fill; cmbApplicationLevel.RightToLeft = System.Windows.Forms.RightToLeft.Yes; cmbApplicationLevel.Margin = new System.Windows.Forms.Padding(8, 4, 12, 4);
            chkAllowOverride = new System.Windows.Forms.CheckBox();
            chkAllowOverride.Name = "chkAllowOverride"; chkAllowOverride.Dock = System.Windows.Forms.DockStyle.Fill; chkAllowOverride.RightToLeft = System.Windows.Forms.RightToLeft.Yes; chkAllowOverride.Margin = new System.Windows.Forms.Padding(8, 4, 12, 4);
            txtCurrentValue = new System.Windows.Forms.TextBox();
            txtCurrentValue.Name = "txtCurrentValue"; txtCurrentValue.Dock = System.Windows.Forms.DockStyle.Fill; txtCurrentValue.RightToLeft = System.Windows.Forms.RightToLeft.Yes; txtCurrentValue.Margin = new System.Windows.Forms.Padding(8, 4, 12, 4);
            cmbSensitivity = new System.Windows.Forms.ComboBox();
            cmbSensitivity.Name = "cmbSensitivity"; cmbSensitivity.Dock = System.Windows.Forms.DockStyle.Fill; cmbSensitivity.RightToLeft = System.Windows.Forms.RightToLeft.Yes; cmbSensitivity.Margin = new System.Windows.Forms.Padding(8, 4, 12, 4);
            chkRequiresRestart = new System.Windows.Forms.CheckBox();
            chkRequiresRestart.Name = "chkRequiresRestart"; chkRequiresRestart.Dock = System.Windows.Forms.DockStyle.Fill; chkRequiresRestart.RightToLeft = System.Windows.Forms.RightToLeft.Yes; chkRequiresRestart.Margin = new System.Windows.Forms.Padding(8, 4, 12, 4);
        ...
        lblScreenCode.Name="lblScreenCode"; lblScreenCode.Text="GEN-016"; lblScreenCode.AutoSize=true; lblScreenCode.Font=new System.Drawing.Font("Segoe UI",11F,System.Drawing.FontStyle.Bold); lblScreenCode.ForeColor=System.Drawing.Color.FromArgb(46,116,181); lblScreenCode.Location=new System.Drawing.Point(0,8);
        lblScreenTitle.Name="lblScreenTitle"; lblScreenTitle.Text="المتغيرات العامة"; lblScreenTitle.AutoSize=true; lblScreenTitle.Font=new System.Drawing.Font("Segoe UI",20F,System.Drawing.FontStyle.Bold); lblScreenTitle.ForeColor=System.Drawing.Color.FromArgb(31,41,55); lblScreenTitle.Location=new System.Drawing.Point(0,27);
        lblBreadcrumb.Name="lblBreadcrumb"; lblBreadcrumb.Text="التهيئة العامة / المتغيرات العامة"; lblBreadcrumb.AutoSize=true; lblBreadcrumb.Font=new System.Drawing.Font("Segoe UI",11F); lblBreadcrumb.ForeColor=System.Drawing.Color.Gray; lblBreadcrumb.Location=new System.Drawing.Point(0,49);
        ...
        AddField(tlpMainData, "مفتاح المتغير", txtVariableKey, 0);
            AddField(tlpMainData, "الاسم العربي", txtNameAr, 1);
            AddField(tlpMainData, "الوصف", rtbDescription, 2);
            AddField(tlpMainData, "المجموعة", cmbGroup, 3);
            AddField(tlpMainData, "نوع البيانات", cmbDataType, 4);
            AddField(tlpMainData, "القيمة الافتراضية", txtDefaultValue, 5);
            AddField(tlpMainData, "مستوى التطبيق", cmbApplicationLevel, 6);
            AddField(tlpMainData, "السماح بالتجاوز", chkAllowOverride, 7);
            AddField(tlpMainData, "القيمة الحالية", txtCurrentValue, 8);
            AddField(tlpMainData, "حساس/غير حساس", cmbSensitivity, 9);
            AddField(tlpMainData, "يحتاج إعادة تشغيل", chkRequiresRestart, 10);
            AddField(tlpMainData, "الحالة", cmbStatus, 11);
        ...
        dgvRecords.Columns.Add(new System.Windows.Forms.DataGridViewTextBoxColumn { Name = "col1", HeaderText = "المفتاح", ReadOnly = true });
        ...
        dgvRecords.Columns.Add(new System.Windows.Forms.DataGridViewTextBoxColumn { Name = "col3", HeaderText = "المجموعة", ReadOnly = true });
        dgvRecords.Columns.Add(new System.Windows.Forms.DataGridViewTextBoxColumn { Name = "col4", HeaderText = "نوع البيانات", ReadOnly = true });
        dgvRecords.Columns.Add(new System.Windows.Forms.DataGridViewTextBoxColumn { Name = "col5", HeaderText = "المستوى", ReadOnly = true });
        ...
        tabScreen = new System.Windows.Forms.TabControl(); tabScreen.Name = "tabScreen"; tabScreen.Dock = System.Windows.Forms.DockStyle.Top; tabScreen.Height = 360; tabScreen.RightToLeft = System.Windows.Forms.RightToLeft.Yes;
            ...
            tabPage2=new System.Windows.Forms.TabPage(); tabPage2.Name="tabPage2"; tabPage2.Text="إعدادات النظام"; tabPage2.RightToLeft=System.Windows.Forms.RightToLeft.Yes;
            tabPage3=new System.Windows.Forms.TabPage(); tabPage3.Name="tabPage3"; tabPage3.Text="سياسات البيانات"; tabPage3.RightToLeft=System.Windows.Forms.RightToLeft.Yes;
            tabPage4=new System.Windows.Forms.TabPage(); tabPage4.Name="tabPage4"; tabPage4.Text="الأمان والجلسات"; tabPage4.RightToLeft=System.Windows.Forms.RightToLeft.Yes;
        ...
        AutoScaleMode=System.Windows.Forms.AutoScaleMode.Font; BackColor=System.Drawing.Color.FromArgb(249,250,251); ClientSize=new System.Drawing.Size(1280,900); Controls.Add(tlpRoot); Font=new System.Drawing.Font("Segoe UI",10F); MinimumSize=new System.Drawing.Size(1180,780); Name="FrmGeneralVariables"; RightToLeft=System.Windows.Forms.RightToLeft.Yes; RightToLeftLayout=true; StartPosition=System.Windows.Forms.FormStartPosition.CenterScreen; Text="GEN-016 — المتغيرات العامة";
        ResumeLayout(false);
    }
