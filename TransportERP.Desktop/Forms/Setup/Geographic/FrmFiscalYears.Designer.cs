...
partial class FrmFiscalYears
{
    ...
    private System.Windows.Forms.TextBox txtFiscalYearCode;
    private System.Windows.Forms.TextBox txtFiscalYearName;
    ...
    private System.Windows.Forms.ComboBox cmbFiscalYearStatus;
    private System.Windows.Forms.ComboBox cmbPeriodPolicy;
    private System.Windows.Forms.CheckBox chkAllowAdjustmentPeriod;
    ...
    private void InitializeComponent()
    {
        ...
        cmbCompany = new System.Windows.Forms.ComboBox();
            ...
            txtFiscalYearCode = new System.Windows.Forms.TextBox();
            txtFiscalYearCode.Name = "txtFiscalYearCode"; txtFiscalYearCode.Dock = System.Windows.Forms.DockStyle.Fill; txtFiscalYearCode.RightToLeft = System.Windows.Forms.RightToLeft.Yes; txtFiscalYearCode.Margin = new System.Windows.Forms.Padding(8, 4, 12, 4);
            txtFiscalYearName = new System.Windows.Forms.TextBox();
            txtFiscalYearName.Name = "txtFiscalYearName"; txtFiscalYearName.Dock = System.Windows.Forms.DockStyle.Fill; txtFiscalYearName.RightToLeft = System.Windows.Forms.RightToLeft.Yes; txtFiscalYearName.Margin = new System.Windows.Forms.Padding(8, 4, 12, 4);
            dtpStartDate = new System.Windows.Forms.DateTimePicker();
            dtpStartDate.Name = "dtpStartDate"; dtpStartDate.Dock = System.Windows.Forms.DockStyle.Fill; dtpStartDate.RightToLeft = System.Windows.Forms.RightToLeft.Yes; dtpStartDate.Margin = new System.Windows.Forms.Padding(8, 4, 12, 4);
            dtpEndDate = new System.Windows.Forms.DateTimePicker();
            dtpEndDate.Name = "dtpEndDate"; dtpEndDate.Dock = System.Windows.Forms.DockStyle.Fill; dtpEndDate.RightToLeft = System.Windows.Forms.RightToLeft.Yes; dtpEndDate.Margin = new System.Windows.Forms.Padding(8, 4, 12, 4);
            nudPeriodCount = new System.Windows.Forms.NumericUpDown();
            nudPeriodCount.Name = "nudPeriodCount"; nudPeriodCount.Dock = System.Windows.Forms.DockStyle.Fill; nudPeriodCount.RightToLeft = System.Windows.Forms.RightToLeft.Yes; nudPeriodCount.Margin = new System.Windows.Forms.Padding(8, 4, 12, 4);
            nudPeriodCount.DecimalPlaces = 2; nudPeriodCount.Maximum = 100000000;
            chkIsCurrent = new System.Windows.Forms.CheckBox();
            chkIsCurrent.Name = "chkIsCurrent"; chkIsCurrent.Dock = System.Windows.Forms.DockStyle.Fill; chkIsCurrent.RightToLeft = System.Windows.Forms.RightToLeft.Yes; chkIsCurrent.Margin = new System.Windows.Forms.Padding(8, 4, 12, 4);
            cmbFiscalYearStatus = new System.Windows.Forms.ComboBox();
            cmbFiscalYearStatus.Name = "cmbFiscalYearStatus"; cmbFiscalYearStatus.Dock = System.Windows.Forms.DockStyle.Fill; cmbFiscalYearStatus.RightToLeft = System.Windows.Forms.RightToLeft.Yes; cmbFiscalYearStatus.Margin = new System.Windows.Forms.Padding(8, 4, 12, 4);
            cmbPeriodPolicy = new System.Windows.Forms.ComboBox();
            cmbPeriodPolicy.Name = "cmbPeriodPolicy"; cmbPeriodPolicy.Dock = System.Windows.Forms.DockStyle.Fill; cmbPeriodPolicy.RightToLeft = System.Windows.Forms.RightToLeft.Yes; cmbPeriodPolicy.Margin = new System.Windows.Forms.Padding(8, 4, 12, 4);
            chkAllowAdjustmentPeriod = new System.Windows.Forms.CheckBox();
            chkAllowAdjustmentPeriod.Name = "chkAllowAdjustmentPeriod"; chkAllowAdjustmentPeriod.Dock = System.Windows.Forms.DockStyle.Fill; chkAllowAdjustmentPeriod.RightToLeft = System.Windows.Forms.RightToLeft.Yes; chkAllowAdjustmentPeriod.Margin = new System.Windows.Forms.Padding(8, 4, 12, 4);
        ...
        lblScreenCode.Name="lblScreenCode"; lblScreenCode.Text="GEN-013"; lblScreenCode.AutoSize=true; lblScreenCode.Font=new System.Drawing.Font("Segoe UI",11F,System.Drawing.FontStyle.Bold); lblScreenCode.ForeColor=System.Drawing.Color.FromArgb(46,116,181); lblScreenCode.Location=new System.Drawing.Point(0,8);
        lblScreenTitle.Name="lblScreenTitle"; lblScreenTitle.Text="السنوات المالية"; lblScreenTitle.AutoSize=true; lblScreenTitle.Font=new System.Drawing.Font("Segoe UI",20F,System.Drawing.FontStyle.Bold); lblScreenTitle.ForeColor=System.Drawing.Color.FromArgb(31,41,55); lblScreenTitle.Location=new System.Drawing.Point(0,27);
        lblBreadcrumb.Name="lblBreadcrumb"; lblBreadcrumb.Text="التهيئة العامة / السنوات المالية"; lblBreadcrumb.AutoSize=true; lblBreadcrumb.Font=new System.Drawing.Font("Segoe UI",11F); lblBreadcrumb.ForeColor=System.Drawing.Color.Gray; lblBreadcrumb.Location=new System.Drawing.Point(0,49);
        ...
        AddField(tlpMainData, "الشركة", cmbCompany, 0);
            AddField(tlpMainData, "رمز السنة", txtFiscalYearCode, 1);
            AddField(tlpMainData, "الاسم", txtFiscalYearName, 2);
            AddField(tlpMainData, "تاريخ البداية", dtpStartDate, 3);
            AddField(tlpMainData, "تاريخ النهاية", dtpEndDate, 4);
            AddField(tlpMainData, "عدد الفترات", nudPeriodCount, 5);
            AddField(tlpMainData, "السنة الحالية", chkIsCurrent, 6);
            AddField(tlpMainData, "حالة السنة", cmbFiscalYearStatus, 7);
            AddField(tlpMainData, "سياسة الفترات", cmbPeriodPolicy, 8);
            AddField(tlpMainData, "السماح بفترة تسويات", chkAllowAdjustmentPeriod, 9);
            AddField(tlpMainData, "الملاحظات", rtbNotes, 10);
        tlpFunctionalScope.Name="tlpFunctionalScope"; tlpFunctionalScope.Dock=System.Windows.Forms.DockStyle.Fill; tlpFunctionalScope.RightToLeft=System.Windows.Forms.RightToLeft.Yes; tlpFunctionalScope.ColumnCount=2; tlpFunctionalScope.Padding=new System.Windows.Forms.Padding(16,8,16,8); tlpFunctionalScope.BackColor=System.Drawing.Color.White; cmbScopeCompany = new System.Windows.Forms.ComboBox();
            cmbScopeCompany.Name="cmbScopeCompany"; cmbScopeCompany.Dock=System.Windows.Forms.DockStyle.Fill; cmbScopeCompany.RightToLeft=System.Windows.Forms.RightToLeft.Yes;
        ...
        dgvRecords.Columns.Add(new System.Windows.Forms.DataGridViewTextBoxColumn { Name = "col1", HeaderText = "الشركة", ReadOnly = true });
        dgvRecords.Columns.Add(new System.Windows.Forms.DataGridViewTextBoxColumn { Name = "col2", HeaderText = "رمز السنة", ReadOnly = true });
        dgvRecords.Columns.Add(new System.Windows.Forms.DataGridViewTextBoxColumn { Name = "col3", HeaderText = "تاريخ البداية", ReadOnly = true });
        dgvRecords.Columns.Add(new System.Windows.Forms.DataGridViewTextBoxColumn { Name = "col4", HeaderText = "تاريخ النهاية", ReadOnly = true });
        dgvRecords.Columns.Add(new System.Windows.Forms.DataGridViewTextBoxColumn { Name = "col5", HeaderText = "الفترات", ReadOnly = true });
        ...
        tabScreen = new System.Windows.Forms.TabControl(); tabScreen.Name = "tabScreen"; tabScreen.Dock = System.Windows.Forms.DockStyle.Top; tabScreen.Height = 360; tabScreen.RightToLeft = System.Windows.Forms.RightToLeft.Yes;
            ...
            tabPage2=new System.Windows.Forms.TabPage(); tabPage2.Name="tabPage2"; tabPage2.Text="الفترات المالية"; tabPage2.RightToLeft=System.Windows.Forms.RightToLeft.Yes;
            tabPage3=new System.Windows.Forms.TabPage(); tabPage3.Name="tabPage3"; tabPage3.Text="الفتح والإغلاق"; tabPage3.RightToLeft=System.Windows.Forms.RightToLeft.Yes;
        ...
        AutoScaleMode=System.Windows.Forms.AutoScaleMode.Font; BackColor=System.Drawing.Color.FromArgb(249,250,251); ClientSize=new System.Drawing.Size(1280,900); Controls.Add(tlpRoot); Font=new System.Drawing.Font("Segoe UI",10F); MinimumSize=new System.Drawing.Size(1180,780); Name="FrmFiscalYears"; RightToLeft=System.Windows.Forms.RightToLeft.Yes; RightToLeftLayout=true; StartPosition=System.Windows.Forms.FormStartPosition.CenterScreen; Text="GEN-013 — السنوات المالية";
        ResumeLayout(false);
    }
