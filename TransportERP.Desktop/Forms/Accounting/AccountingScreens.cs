...
public sealed class FrmTrialBalance : AccountingReportScreenForm { public FrmTrialBalance() : base("ACC-024", "ميزان المراجعة", "من تاريخ", "إلى تاريخ", "مستوى الحساب", "الفرع", "مركز التكلفة", "العملة", "شامل الصفر") { } }
public sealed class FrmIncomeStatement : AccountingReportScreenForm { public FrmIncomeStatement() : base("ACC-025", "قائمة الدخل", "من تاريخ", "إلى تاريخ", "الشركة", "الفرع", "مركز التكلفة", "مقارنة بفترة", "العملة") { } }
public sealed class FrmBalanceSheet : AccountingReportScreenForm { public FrmBalanceSheet() : base("ACC-026", "الميزانية العمومية", "حتى تاريخ", "الشركة", "الفرع", "مركز التكلفة", "مستوى العرض", "العملة") { } }
public sealed class FrmCashFlowStatement : AccountingReportScreenForm { public FrmCashFlowStatement() : base("ACC-027", "قائمة التدفقات النقدية", "من تاريخ", "إلى تاريخ", "الشركة", "الفرع", "العملة", "طريقة العرض") { } }
