...
- W2 exact actions only: `ACC044.View/Create/Edit/Cancel/Post/Reverse`; List/Get/Create/Update/Cancel/Post/Reverse.
...
Purpose: create and maintain a payment Draft, then cancel/post/reverse through server-authoritative commands.
...
Server/domain authority owns date/period validation, party/source/destination validity, posting rules, exchange-rate semantics and accounting effects. Exact field-to-W1/DTO/API bindings stay TBD-GATED where unissued.
...
- FBR-040..041 field-level mapping closure.
...
Verify identity/profile/variant; exact five tabs, 11 fields and 8 columns; actions exactly View/Create/Edit/Cancel/Post/Reverse; no Print/Export/attachment/direct-approval/offline action; posted immutability; owner decision remains UI-only; technical gaps remain TBD-GATED; no CoreUI duplication or client accounting formula.
