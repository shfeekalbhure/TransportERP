...
| Database / EF / Migrations | PARTIAL / live blocked; C1-CORR-001 accepted | COVERED WITH CONSTRAINTS | C2-EV-004/012/015/017/018/023/029 | DB-GOV constraints; fail-closed factory preserved; live state/tool execution unknown |
...
| Offline / Sync | STATIC RECONCILED — SCOPE EXPANDED P1 | COVERED — POLICY GATED | C2-EV-016/030 | typed outbox/inbox/PoP/pull/conflict plus owner-bound lifecycle/override; exposure and write authority unresolved |
| EF design-time configuration | CORRECTED STATIC FACT | COVERED WITH FAIL-CLOSED CONSTRAINT | C2-EV-029 | explicit controlled env value only; runtime tooling success unknown |
