...
| `E-EV-026` | TEAM-E v1.0 return/reissue | E-SRC-015 | SHA-256/internal consistency | v1.0 detached list and P0/P1 matrix vs reopen register/final report | 15/15 hashes pass; stale `REOPEN REQUIRED` dispositions on A-OFF-002/TB-F-004 contradict resolved D/C2 v1.1 chain; requires immutable v1.1 reissue, not finding reprioritization |
