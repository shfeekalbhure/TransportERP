...
- Package: `MISSION-02-v1.1`
- Handoff: `COMPLETE — READY FOR CONTROL TOWER HASH VERIFICATION`
- Mission state: `MISSION-02 = SEALED — READY FOR MISSION-03`
...
6. Record this package as `MISSION-02 = SEALED — READY FOR MISSION-03` and issue a separate MISSION-03 start order if execution is authorized.
