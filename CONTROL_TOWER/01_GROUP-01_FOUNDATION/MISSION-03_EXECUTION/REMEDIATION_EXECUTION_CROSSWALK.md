...
| `REM-200` | W2 | `PRESERVED CANDIDATE — REVALIDATION REQUIRED` | B1/B2A technical evidence exists, but superseding Control Tower hold prevents adoption; AUTH-001/DBP-003 remain |
| `REM-210` | W2 | `PRESERVED CANDIDATE — REVALIDATION REQUIRED` | A1/A2 technical evidence exists, but superseding Control Tower hold requires independent ADR verification/rebinding; DBP-002 remains |
| `REM-220` | W2 | `PRESERVED CANDIDATE — REVALIDATION REQUIRED` | C1 technical evidence exists; registry/PoP/override/DBP-003/006 remain blocked and candidate adoption is held |
